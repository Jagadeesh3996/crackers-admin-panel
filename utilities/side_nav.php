...
<aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="#" class="navbar-brand pe-0">
            ...
            <!--logo End-->
            <h4 class="logo-title ms-2" style="font-size: 18px;">Demo Crackers</h4>
        </a>
        <div class="sidebar-toggle" data-toggle="sidebar" data-active="true">
            <i class="icon">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.25 12.2744L19.25 12.2744" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path d="M10.2998 18.2988L4.2498 12.2748L10.2998 6.24976" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                </svg>
            </i>
        </div>
    </div>
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                <li class="nav-item">
                    <a class="nav-link index" aria-current="page" href="<?= $admin_url ?>/">
                        <i class="icon">
                            <svg width="20" class="icon-20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="horizontal-menu1" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link homebanner" href="<?= $admin_url ?>/pages/homebanner/">
                                <i class="icon">
                        ...
                        <!-- <li class="nav-item">
                            <a class="nav-link scrollbar" href="../dashboard/scrollbar.php">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <span class="item-name"> Scroll Bar </span>
                            </a>
                        </li> -->
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link coupon category product section" data-bs-toggle="collapse" href="#horizontal-menu" role="button" aria-expanded="false" aria-controls="horizontal-menu">
                        ...
                        <span class="item-name">Our Shop</span>
                        <i class="right-icon">
                            <svg class="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                ...
                <li class="nav-item">
                    <a class="nav-link transport transport_details" aria-current="page" href="../dashboard/transport.php">
                        <i class="icon">
                            <svg width="20" class="icon-20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                ...
                <li class="nav-item">
                    <a class="nav-link delivery" aria-current="page" href="../dashboard/delivery.php">
                        <i class="icon">
                            <svg width="20" class="icon-20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                <path d="M48 0C21.5 0 0 21.5 0 48V368c0 26.5 21.5 48 48 48H64c0 53 43 96 96 96s96-43 96-96H384c0 53 43 96 96 96s96-43 96-96h32c17.7 0 32-14.3 32-32s-14.3-32-32-32V288 256 237.3c0-17-6.7-33.3-18.7-45.3L512 114.7c-12-12-28.3-18.7-45.3-18.7H416V48c0-26.5-21.5-48-48-48H48zM416 160h50.7L544 237.3V256H416V160zM112 416a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm368-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96z" fill="currentColor" />
                            </svg>
                ...
                <li class="nav-item">
                    <a class="nav-link billing viewbilling" aria-current="page" href="../dashboard/billing.php">
                        <i class="icon">
                            <svg width="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="icon-20" fill="none">
                ...
                <li class="nav-item">
                    <a class="nav-link invoice viewinvoice" aria-current="page" href="../dashboard/invoice.php">
                        <i class="icon">
                            <svg width="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="icon-20" fill="none">
                                <path fill="currentColor" d="M128 0C92.7 0 64 28.7 64 64v96h64V64H354.7L384 93.3V160h64V93.3c0-17-6.7-33.3-18.7-45.3L400 18.7C388 6.7 371.7 0 354.7 0H128zM384 352v32 64H128V384 368 352H384zm64 32h32c17.7 0 32-14.3 32-32V256c0-35.3-28.7-64-64-64H64c-35.3 0-64 28.7-64 64v96c0 17.7 14.3 32 32 32H64v64c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V384zM432 248a24 24 0 1 1 0 48 24 24 0 1 1 0-48z" />
                            </svg>
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link reports" aria-current="page" href="../dashboard/reports.php">
                        <i class="icon">
                            <svg width="20" class="icon-20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                                <path d="M0 64C0 28.7 28.7 0 64 0H224V128c0 17.7 14.3 32 32 32H384V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V64zm384 64H256V0L384 128z" fill="currentColor"/>
                            </svg>
                        </i>
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link ourstaff" aria-current="page" href="../dashboard/ourstaff.php">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="item-name">Our Staff</span>
                    </a>
                </li> -->
                <li class="nav-item">
                    <a class="nav-link testimonial" aria-current="page" href="../dashboard/testimonial.php">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                
                        ...
                        <span class="item-name">Testimonial</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link contact" aria-current="page" href="../dashboard/contact.php">
                        <i class="icon">
                            <svg width="17" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <li class="nav-item">
                    <a class="nav-link shopsetting" aria-current="page" href="../dashboard/shopsetting.php">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="item-name">Shop Setting</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link logout" onclick="logoutPopup();">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
