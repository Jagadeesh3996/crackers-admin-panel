...
<?php
    ...
    $query = "SELECT * FROM tbl_invoice where status>='1' order by date DESC, id DESC";
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="flex-wrap d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <a href="invoice.php"><button type="button" class="btn btn-success">
                                        ...
                                        <tbody id='record'>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class='btn btn-sm btn-icon btn-success' href='invoicepdf.php?invoice=<?= $bitem['invoice'] ?>' target='_blank' data-bs-toggle='tooltip' title='View' data-bs-placement='top'>
        ...
        <script>
            ...
            const delDatas = (id)=>{
                $.ajax({
                    ...
                    data: { req_type: 'deleteinvoice', id: id },
                    success: (response)=>{
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: 'POST',
                            url: 'backend/billing.php',
                            data: { req_type: 'deleteinvoice', id: itemId },
                            success: (response)=>{
                                if (response.trim() === "success") {
                                    Swal.fire({
