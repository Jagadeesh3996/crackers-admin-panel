                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="<?= $admin_url ?>/pages/invoice/"><button type="button" class="btn btn-success">
                                    ...
                                    <tbody id='record'>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class='btn btn-sm btn-icon btn-success' href='<?= $admin_url ?>/pages/invoicepdf?invoice=<?= $bitem['invoice'] ?>' target='_blank' data-bs-toggle='tooltip' title='View' data-bs-placement='top'>
