...
<html lang="en" dir="ltr">
    ...
    <body>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="flex-wrap d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <a href="viewinvoice.php"><button type="button" class="btn btn-success">
        ...
        <script>
            let list=[]; itemno=1; nameList=[]; disper=80; productList = []; todayDate = 0;
            $(".totaltr").hide();
            $("#editProducts").hide();
            $(".gstdiv").hide();
            $(".packdiv").hide();
                    ...
                    success: (response)=>{
                        if (response.trim() == "success") {
                            Swal.fire({
                                ...
                                window.open("invoicepdf.php?invoice=<?= $invoice ?>", "_blank");
