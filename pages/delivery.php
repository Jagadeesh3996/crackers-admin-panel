...
$query = "SELECT * FROM tbl_state WHERE status = 1 ORDER BY id DESC";
...
<body>
                                ...
                                <table id="datatable" class="table table-striped" data-toggle="data-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Max Order value</th>
                                    ...
                                    <tbody id='record'>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $serialNumber++ ?></td>
                                                <td><?= $state['state'] ?></td>
                                                <td>&#8377; <?= number_format($state['minimum_order_value']) ?></td>
                                                <td>&#8377; <?= number_format($state['max_order_value']) ?></td>
                                                <td><?= $state['packing_charge'] ?> %</td>
                                                <td>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="mxvalue" id="mxvalue" required>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <label class="form-label" for="pcharge">Packing Charge (%)</label>
                            <input type="number" class="form-control" name="pcharge" id="pcharge" oninput="valitate()" required>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        const delDatas = (id) => {
            $.ajax({
                type: 'POST',
                url: '<?= $admin_url ?>/backend/delivery/',
                data: {
                    req_type: 'delete',
                    state_id: id
                },
